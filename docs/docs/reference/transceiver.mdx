...
| transceiver_type | Type of transceiver, such as LR, SR, T. | Dropdown | False |  | lr, sr, lrm, t, sr4, lr4, dr4, zr, er, dac, aoc |
...
- name: GenericTransceiver
  ...
  - name: transceiver_type
    ...
    - name: lr4
      ...
      color: '#336699'
    - name: dr4
      label: DR4 (500m Range 4-lane)
      description: 500 m 4-lane transceiver over parallel single mode fiber.
      color: '#339966'
    - name: zr
