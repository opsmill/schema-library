...
- **Description:** Generic Connector to link two endpoints together. The endpoints are kind Attribute so both ends render inline on the connector form; a high-fan-out connector kind should override the relationship back to Generic.
- **Namespace:** Dcim
...
- name: Connector
  namespace: Dcim
  description: Generic Connector to link two endpoints together. The endpoints are
    kind Attribute so both ends render inline on the connector form; a high-fan-out
    connector kind should override the relationship back to Generic.
  include_in_menu: false
  relationships:
