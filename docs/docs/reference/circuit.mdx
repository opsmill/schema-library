...
- **Description:** One of the two terminations (A or Z) of a circuit, at the location where the provider hands the circuit off. Use the description field for the provider-side reference (patch panel position, cross-connect ID).
- **Namespace:** Dcim
- **Icon:** mdi:ethernet
...
- name: CircuitEndpoint
  ...
  description: One of the two terminations (A or Z) of a circuit, at the location
    where the provider hands the circuit off. Use the description field for the provider-side
    reference (patch panel position, cross-connect ID).
  label: Circuit Endpoint
  icon: mdi:ethernet
  include_in_menu: true
