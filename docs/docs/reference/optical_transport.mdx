...
- name: TransponderModule
  ...
  - name: computed_name
    ...
    computed_attribute:
      kind: Jinja2
      jinja2_template: '{{ module_bay__device__serial__value }}-TPD-{{ slot_number__value
        }}'
...
- name: OpticalMultiplexerModule
  ...
  - name: computed_name
    ...
    computed_attribute:
      kind: Jinja2
      jinja2_template: '{{ module_bay__device__serial__value }}-MUX-{{ slot_number__value
        }}'
...
- name: OpticalAmplifierModule
  ...
  - name: computed_name
    ...
    computed_attribute:
      kind: Jinja2
      jinja2_template: '{{ module_bay__device__serial__value }}-AMP-{{ slot_number__value
        }}'
