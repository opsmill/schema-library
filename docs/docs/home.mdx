...
| **[Rack](./reference/rack.mdx)** | This schema extension introduces a Rack model representing a physical equipment rack installed at a site. Racks can be placed at a LocationSite and can host devices and other equipment. |
